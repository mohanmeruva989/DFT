//
// CommentsTypeMasterViewController.swift
// DFT
//
...
class CommentsTypeMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([CommentsType]?, Error?) -> Void) -> Void)?
    private var entities: [CommentsType] = [CommentsType]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let commentstype = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "commentId", value: "\(commentstype.commentID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! CommentsTypeDetailViewController
            detailViewController.entity = selectedEntity
            detailViewController.navigationItem.leftItemsSupplementBackButton = true
            detailViewController.navigationItem.title = "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].commentID != nil ? "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].commentID!)" : "")"
...
extension CommentsTypeMasterViewController: EntitySetUpdaterDelegate {
