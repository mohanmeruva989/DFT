...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate, OnboardingManagerDelegate, ConnectivityObserver, UNUserNotificationCenterDelegate {
    ...
    func onboarded(onboardingContext: OnboardingContext, onboarding _: Bool) {
        ...
        Alamofire.request("https://mobile-hkea136m18.hana.ondemand.com/com.getloggedinUser.dest", method: .get, parameters: nil, encoding: URLEncoding.default, headers: nil)
        .responseJSON{ response in
            self.getUserDetail(id: "P000066")
    ...
    Alamofire.request("https://mobile-hkea136m18.hana.ondemand.com/nctureIDPDestination/service/scim/Users/" + id, method: .get, parameters: nil, encoding: URLEncoding.default, headers: nil)
    .responseJSON{ response in
...
//            (masterViewController as! DFTHeaderTypeMasterViewController).entitySetName = "DFTHeader"
            func fetchDFTHeader(_ completionHandler: @escaping ([DFTHeaderType]?, Error?) -> Void) {
                ...
                let queryFilter = DFTHeaderType.serviceProviderID.equal("")
