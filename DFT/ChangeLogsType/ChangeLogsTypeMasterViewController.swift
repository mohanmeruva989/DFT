//
// ChangeLogsTypeMasterViewController.swift
// DFT
//
...
class ChangeLogsTypeMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ChangeLogsType]?, Error?) -> Void) -> Void)?
    private var entities: [ChangeLogsType] = [ChangeLogsType]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let changelogstype = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "activityId", value: "\(changelogstype.activityID!)")
        return cell
    }
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        self.getFieldTicketDetails.deleteEntity(currentEntity) { error in
            if let error = error {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ChangeLogsTypeDetailViewController
            detailViewController.entity = selectedEntity
            detailViewController.navigationItem.leftItemsSupplementBackButton = true
            detailViewController.navigationItem.title = "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].activityID != nil ? "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].activityID!)" : "")"
...
extension ChangeLogsTypeMasterViewController: EntitySetUpdaterDelegate {
