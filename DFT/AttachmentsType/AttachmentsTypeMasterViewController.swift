//
// AttachmentsTypeMasterViewController.swift
// DFT
//
...
class AttachmentsTypeMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([AttachmentsType]?, Error?) -> Void) -> Void)?
    private var entities: [AttachmentsType] = [AttachmentsType]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let attachmentstype = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "attachmentId", value: "\(attachmentstype.attachmentID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! AttachmentsTypeDetailViewController
            detailViewController.entity = selectedEntity
            detailViewController.navigationItem.leftItemsSupplementBackButton = true
            detailViewController.navigationItem.title = "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].attachmentID != nil ? "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].attachmentID!)" : "")"
...
extension AttachmentsTypeMasterViewController: EntitySetUpdaterDelegate {
