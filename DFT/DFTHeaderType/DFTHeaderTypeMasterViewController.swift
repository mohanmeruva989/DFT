//
// DFTHeaderTypeMasterViewController.swift
// DFT
//
...
class DFTHeaderTypeMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var entities: [DFTHeaderType] = [DFTHeaderType]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let dftheadertype = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "dftNumber", value: "\(dftheadertype.dftNumber!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! DFTHeaderTypeDetailViewController
            detailViewController.entity = selectedEntity
            detailViewController.navigationItem.leftItemsSupplementBackButton = true
            detailViewController.navigationItem.title = "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].dftNumber != nil ? "\(self.entities[(self.tableView.indexPathForSelectedRow?.row)!].dftNumber!)" : "")"
...
extension DFTHeaderTypeMasterViewController: EntitySetUpdaterDelegate {
